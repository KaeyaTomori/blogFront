  ...
  <div>
    <div class="introduction">
      <el-card id="user-card" class="box-card tools-item" :body-style="{ padding: '0px' }">
        ...
        <div
          class="backimg"
          :style="{background: 'url(' + profileCard.imageUrl + ') center center',backgroundSize: '100%'}"
        >
          <div class="photo-wrapper clearfix">
            <div class="photo-wrapper-tip text-center">
              <img :src="profileCard.avatarUrl" alt class="about-photo" />
            </div>
          </div>
        </div>

        <p class="desc">{{profileCard.name}}</p>

        <div
          id="rollText"
          class="m-margin-top"
          style="font-size: 15px;"
          v-if="profileCard.rollText.length!=0"
        ></div>
        ...
        <el-tooltip
          ...
          content="Github"
          placement="top"
          v-if="profileCard.github"
        >
          <a :href="profileCard.github" target="_blank">
            <svg
        ...
        <el-tooltip
          ...
          content="bilibili"
          placement="top"
          v-if="profileCard.bilibili"
        >
          <a :href="profileCard.bilibili" target="_blank">
            <svg
              style="width: 1.5em!important;height: 1.5em!important;"
              t="1614337365422"
              class="icon"
        ...
        <el-tooltip
          ...
          content="邮箱"
          placement="top"
          v-if="profileCard.email"
        >
          <a :href="profileCard.email" target="_blank">
            <svg
              style="width: 1.5em!important;height: 1.5em!important;"
              t="1614337206892"
              class="icon"
